...
public class LaifangdengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,LaifangdengjiEntity laifangdengji, 
		...
		if(tableName.equals("xuesheng")) {
			laifangdengji.setLaifangxuesheng((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			wrapper.eq("laifangxuesheng", (String)request.getSession().getAttribute("username"));
		}
