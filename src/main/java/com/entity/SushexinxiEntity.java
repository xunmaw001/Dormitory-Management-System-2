...
public class SushexinxiEntity<T> implements Serializable {
	 ...
	 * 设置：宿舍成员
	 */
	public void setSushechengyuan(String sushechengyuan) {
		this.sushechengyuan = sushechengyuan;
	}
	/**
	 * 获取：宿舍成员
	 */
	public String getSushechengyuan() {
		return sushechengyuan;
	}
