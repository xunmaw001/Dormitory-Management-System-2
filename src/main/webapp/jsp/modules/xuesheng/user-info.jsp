						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>班级名称</label>
										<select id="banjimingchengSelect" name="banjimingcheng" disabled="disabled" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>宿舍号</label>
										<select id="sushehaoSelect" name="sushehao" disabled="disabled" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>联系方式</label>
